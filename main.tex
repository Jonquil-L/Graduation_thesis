...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% 请在下方修改论文标题 %%%%%
\fancyhead[CE]{\xiaowu\song 用于最优控制问题的鲁棒物理信息神经网络}
%%%%% 请在上方修改论文标题 %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{titlepage}
    \begin{center}
        ...
        % 中文标题：二号黑体
        {\hei\erhao 用于最优控制问题的鲁棒物理信息神经网络}\\[10mm]
        % 英文标题：三号 Times New Roman 加粗
        {\bfseries\sanhao ROBUST-PINN FOR OPTIMAL CONTROL PROBLEMS}\\[20mm]

        {\xiaosi
        \renewcommand\arraystretch{1.8}
        \begin{tabular}{r@{：}l}
            姓\hspace{2em}名 & 兰景琪 \\
            学\hspace{2em}号 & 37720222205026 \\
            学\hspace{2em}院 & 数学科学学院 \\
            专\hspace{2em}业 & 信息与计算科学专业 \\
            年\hspace{2em}级 & 2022级 \\
            校内指导教师 & 谭志裕\hspace{1em}副教授 \\
