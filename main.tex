...
% 中文字体族（macOS 字体名）
% 如缺少字体请参照 README 说明安装
\setCJKmainfont{STSong}                        % 宋体（华文宋体，系统自带）
\setCJKsansfont[BoldFont=Heiti SC]{Heiti SC}   % 黑体（系统自带）
\setCJKmonofont{STFangsong}                    % 仿宋（需安装）

\setCJKfamilyfont{zhsong}{STSong}
\setCJKfamilyfont{zhhei}[BoldFont=Heiti SC]{Heiti SC}
\setCJKfamilyfont{zhkai}{STKaiti}              % 楷体（需安装）
\setCJKfamilyfont{zhfs}{STFangsong}            % 仿宋（需安装）
